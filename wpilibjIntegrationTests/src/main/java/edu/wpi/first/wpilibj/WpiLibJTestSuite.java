...
/**
 * @author Jonathan Leitschuh Holds all of the tests in the root wpilibj directory Please list
 *         alphabetically so that it is easy to determine if a test is missing from the list
 */
@RunWith(Suite.class)
