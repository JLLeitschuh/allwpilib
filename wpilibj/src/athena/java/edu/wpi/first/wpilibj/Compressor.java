...
public class Compressor extends SensorBase implements LiveWindowSendable {
   ...
   *
   * @param pcmId The PCM CAN device ID. Most robots that use PCM will have a single module. Use
   *              this for supporting a second module other than the default.
   */
  ...
  /**
   * @return true if PCM is in fault state : Compressor Drive is disabled due to compressor current
   * being too high.
   */
  ...
  /**
   * @return true if PCM sticky fault is set : Compressor Drive is disabled due to compressor
  ...
  /**
   * @return true if PCM sticky fault is set : Compressor does not appear to be wired, i.e.
   * compressor is not drawing enough current.
   */
  ...
  /**
   * @return true if PCM is in fault state : Compressor does not appear to be wired, i.e. compressor
   * is not drawing enough current.
   */
