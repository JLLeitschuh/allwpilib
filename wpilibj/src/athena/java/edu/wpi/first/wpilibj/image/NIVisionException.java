...
public class NIVisionException extends Exception {
  ...
  private static String lookUpCode(int errorCode) {
    ...
    switch (errorCode) {
      ...
      case -1074396136:
        return "The filter quality you provided is invalid. Valid quality values range from -1 to"
            + " 1000.";
      case -1074396135:
        return "Invalid button label.";
      case -1074396134:
        return "Could not execute the function in the separate thread because the thread has not "
            + "completed initialization.";
      case -1074396133:
        return "Could not execute the function in the separate thread because the thread could "
            + "not initialize.";
      case -1074396132:
        return "The mask must be the same size as the template.";
      case -1074396130:
        return "The ROI must only have either a single Rectangle contour or a single Rotated "
            + "Rectangle contour.";
      case -1074396129:
        return "During timed execution, you must use the preallocated version of this operation.";
      case -1074396128:
        return "An image being modified by one process cannot be requested by another process "
            + "while a time limit is active.";
      case -1074396127:
        return "An image with pattern matching, calibration, or overlay information cannot be "
            + "manipulated while a time limit is active.";
      case -1074396126:
        return "An image created before a time limit is started cannot be resized while a time "
            + "limit is active.";
      case -1074396125:
      ...
      case -1074396120:
        return "Not an image.";
      case -1074396119:
        return "They custom data key you supplied is invalid. The only valid character values are"
            + " decimal 32-126 and 161-255. There must also be no repeated, leading, or trailing "
            + "spaces.";
      case -1074396118:
      ...
      case -1074396114:
        return "The ROI contains an invalid contour type or is not contained in the ROI learned "
            + "for calibration.";
      case -1074396113:
      ...
      case -1074396095:
        return "The reference points passed are inconsistent.  At least two similar pixel "
            + "coordinates correspond to different real-world coordinates.";
      case -1074396094:
        return "A resource conflict occurred in the timed environment. Two processes cannot "
            + "manage the same resource and be time bounded.";
      case -1074396093:
        return "A resource conflict occurred in the timed environment. Two processes cannot "
            + "access the same resource and be time bounded.";
      case -1074396092:
      ...
      case -1074396082:
        return "Only 8-bit images support the use of palettes.  Either do not use a palette, or "
            + "convert your image to an 8-bit image before using a palette.";
      case -1074396081:
      ...
      case -1074396063:
        return "The external buffer must be aligned on a 4-byte boundary. The line width and "
            + "border pixels must be 4-byte aligned, as well.";
      case -1074396062:
        return "The tolerance parameter must be greater than or equal to 0.";
      case -1074396061:
        return "The size of each dimension of the window must be greater than 2 and less than or "
            + "equal to the size of the image in the corresponding dimension.";
      case -1074396060:
        return "Lossless compression cannot be used with the floating point wavelet transform "
            + "mode. Either set the wavelet transform mode to integer, or use lossy compression.";
      case -1074396059:
        return "Invalid maximum number of iterations. Maximum number of iterations must be "
            + "greater than zero.";
      case -1074396058:
      ...
      case -1074396046:
        return "When using a region of interest that is not a rectangle, you must specify the "
            + "contrast mode of the barcode as either black on white or white on black.";
      case -1074396045:
      ...
      case -1074396035:
        return "The template image does not contain enough information for learning the "
            + "aggressive search strategy.";
      case -1074396034:
        return "The template image does not contain enough edge information for the sample size"
            + "(s) requested.";
      case -1074396033:
        return "Invalid template descriptor.";
      case -1074396032:
        return "The template descriptor does not contain data required for the requested search "
            + "strategy in rotation-invariant matching.";
      case -1074396026:
      ...
      case -1074396021:
        return "Invalid kernel size for edge detection. The minimum kernel size is 3, the maximum"
            + " kernel size is 1073741823 and the kernel size must be odd.";
      case -1074396020:
      ...
      case -1074396017:
        return "The AIM grading data attached to the image you tried to open was created with a "
            + "newer version of NI Vision. Upgrade to the latest version of NI Vision to read this "
            + "file.";
      case -1074396016:
      ...
      case -1074396014:
        return "RT Video Out does not support displaying the supplied image type at the selected "
            + "color depth.";
      case -1074396013:
      ...
      case -1074396009:
        return "An internal DirectX error has occurred.  Try upgrading to the latest version of "
            + "DirectX.";
      case -1074396008:
        return "An appropriate DirectX filter to process this file could not be found.  Install "
            + "the filter that was used to create this AVI. Upgrading to the latest version of "
            + "DirectX may correct this error.  NI Vision requires DirectX 8.1 or higher.";
      case -1074396007:
      ...
      case -1074396003:
        return "The data for this frame exceeds the data buffer size specified when creating the "
            + "AVI file.";
      case -1074396002:
        return "Invalid line gauge method.";
      case -1074396001:
        return "There are too many AVI sessions open.  You must close a session before you can "
            + "open another one.";
      case -1074396000:
      ...
      case -1074395979:
        return "The image has invalid particle information.  Call imaqCountParticles on the image"
            + " to create particle information.";
      case -1074395978:
        return "Invalid particle number.";
      case -1074395977:
        return "The AVI file was created in a newer version of NI Vision. Upgrade to the latest "
            + "version of NI Vision to read this AVI file.";
      case -1074395976:
        return "The color palette must have exactly 0 or 256 entries.";
      case -1074395975:
        return "DirectX has timed out reading or writing the AVI file.  When closing an AVI file,"
            + " try adding an additional delay.  When reading an AVI file, try reducing CPU and "
            + "disk load.";
      case -1074395974:
      ...
      case -1074395972:
        return "DirectX is unable to enumerate the compression filters. This is caused by a "
            + "third-party compression filter that is either improperly installed or is preventing "
            + "itself from being enumerated. Remove any recently installed compression filters and "
            + "try again.";
      case -1074395971:
      ...
      case -1074395798:
        return "The size of the feature vector in the custom sample must match the size of those "
      ...
      case -1074395793:
        return "This classifier session is compact. Only the Classify and Dispose functions may "
            + "be called on a compact classifier session.";
      case -1074395792:
        return "This classifier session is not trained. You may only call this function on a "
            + "trained classifier session.";
      case -1074395791:
      ...
      case -1074395789:
        return "The classifier session you tried to open was created with a newer version of NI "
            + "Vision. Upgrade to the latest version of NI Vision to read this file.";
      case -1074395788:
      ...
      case -1074395776:
        return "You can not use a compact classification file with read options other than Read "
            + "All.";
      case -1074395775:
      ...
      case -1074395771:
        return "The golden template you tried to open was created with a newer version of NI "
            + "Vision. Upgrade to the latest version of NI Vision to read this file.";
      case -1074395770:
      ...
      case -1074395766:
        return "This backwards-compatibility function can not be used with this session. Use "
            + "newer, supported functions instead.";
      case -1074395763:
      ...
      case -1074395727:
        return "NI Vision does not support the search mode you provided for the type of 2D "
            + "barcode for which you are searching.";
      case -1074395726:
        return "matchFactor has been obsoleted. Instead, set the initialMatchListLength and "
            + "matchListReductionFactor in the MatchPatternAdvancedOptions structure.";
      case -1074395725:
        return "The data was stored with a newer version of NI Vision. Upgrade to the latest "
            + "version of NI Vision to read this data.";
      case -1074395724:
        return "The size you specified is out of the valid range.";
      case -1074395723:
        return "The key you specified cannot be found in the image.";
      case -1074395722:
        return "Custom classifier sessions only classify feature vectors. They do not support "
            + "classifying images.";
      case -1074395721:
      ...
      case -1074395718:
        return "The version of LabVIEW or BridgeVIEW you are running does not support this "
            + "operation.";
      case -1074395717:
      ...
      case -1074395706:
        return "This AVI session is already open. You must close it before calling the Create or "
            + "Open functions.";
      case -1074395705:
      ...
      case -1074395701:
        return "The maximum Data Matrix barcode size must be equal to or greater than the minimum"
            + " Data Matrix barcode size.";
      case -1074395700:
        return "The function requires the operating system to be Microsoft Windows 2000 or newer.";
      case -1074395656:
        return "You must specify the same value for the smooth contours advanced match option for"
            + " all templates you want to match.";
      case -1074395655:
        return "You must specify the same value for the enable calibration support advanced match"
            + " option for all templates you want to match.";
      case -1074395654:
        return "The source image does not contain grading information. You must prepare the "
            + "source image for grading when reading the Data Matrix, and you cannot change the "
            + "contents of the source image between reading and grading the Data Matrix.";
      case -1074395653:
        return "The multiple geometric matching template you tried to open was created with a "
            + "newer version of NI Vision. Upgrade to the latest version of NI Vision to read this "
            + "file.";
      case -1074395652:
        return "The geometric matching template you tried to open was created with a newer "
            + "version of NI Vision. Upgrade to the latest version of NI Vision to read this file.";
      case -1074395651:
        return "You must specify the same edge filter size for all the templates you want to "
            + "match.";
      case -1074395650:
        return "You must specify the same curve extraction mode for all the templates you want to"
            + " match.";
      case -1074395649:
      ...
      case -1074395633:
        return "Invalid minimum match separation scale.  Values must be greater than or equal to "
            + "-1.";
      case -1074395632:
        return "Invalid minimum match separation angle.  Values must be between -1 and 360.";
      case -1074395631:
        return "Invalid minimum match separation distance.  Values must be greater than or equal "
            + "to -1.";
      case -1074395630:
        return "Invalid maximum number of features learn. Values must be integers greater than "
            + "zero.";
      case -1074395629:
      ...
      case -1074395626:
        return "The template does not contain enough features for geometric matching.";
      case -1074395625:
        return "You specified an invalid value for the match constraint value of the  range "
            + "settings.";
      case -1074395624:
        return "Invalid occlusion range. Valid values for the bounds range from 0 to 100 and the "
            + "upper bound must be greater than or equal to the lower bound.";
      case -1074395623:
        return "Invalid scale range. Values for the lower bound must be a positive real numbers "
            + "and the upper bound must be greater than or equal to the lower bound.";
      case -1074395622:
      ...
      case -1074395617:
        return "The minimum number of features must be less than or equal to the maximum number "
            + "of features.";
      case -1074395616:
      ...
      case -1074395614:
        return "Invalid aspect ratio for rectangular features. Values must be positive real "
            + "numbers in the range 0.01 to 1.0.";
      case -1074395613:
        return "Invalid minimum length for linear features. Values must be integers greater than "
            + "0.";
      case -1074395612:
        return "Invalid minimum radius for circular features. Values must be integers greater "
            + "than 0.";
      case -1074395611:
      ...
      case -1074395607:
        return "Invalid maximum number of features used per match. Values must be integers "
            + "greater than or equal to zero.";
      case -1074395606:
        return "Invalid minimum number of features used for matching. Values must be integers "
            + "greater than zero.";
      case -1074395605:
      ...
      case -1074395594:
        return "Invalid substitution character. Valid substitution characters are ASCII values "
            + "that range from 1 to 254.";
      case -1074395593:
      ...
      case -1074395582:
        return "Invalid maximum horizontal element spacing value. Maximum horizontal element "
            + "spacing must be >= 0.";
      case -1074395581:
        return "Invalid maximum vertical element spacing value. Maximum vertical element spacing "
            + "must be >= 0.";
      case -1074395580:
        return "Invalid minimum bounding rectangle width. Minimum bounding rectangle width must "
            + "be >= 1.";
      case -1074395579:
      ...
      case -1074395573:
        return "The character set file was created by a newer version of NI Vision. Upgrade to "
            + "the latest version of NI Vision to read the character set file.";
      case -1074395572:
      ...
      case -1074395561:
        return "The number of characters in the character value must match the number of objects "
            + "in the image.";
      case -1074395560:
      ...
      case -1074395557:
        return "The minimum character bounding rectangle width must be less than the maximum "
            + "character bounding rectangle width.";
      case -1074395556:
        return "The minimum character bounding rectangle height must be less than the maximum "
            + "character bounding rectangle height.";
      case -1074395555:
        return "The maximum horizontal element spacing value must not exceed the minimum "
            + "character spacing value.";
      case -1074395554:
        return "Invalid read resolution.";
      case -1074395553:
        return "Invalid minimum bounding rectangle height. The minimum bounding rectangle height "
            + "must be >= 1.";
      case -1074395552:
      ...
      case -1074395549:
        return "The number of objects found does not match the number of expected characters or "
            + "patterns to verify.";
      case -1074395410:
      ...
      case -1074395404:
        return "UnwrapImage does not support the interpolation method value you supplied.  Valid "
            + "interpolation methods are zero order and bilinear. ";
      case -1074395403:
        return "The image was created in a newer version of NI Vision. Upgrade to the latest "
            + "version of NI Vision to use this image.";
      case -1074395402:
      ...
      case -1074395400:
        return "The operation you have given Multicore Options is invalid. Please see the "
            + "available enumeration values for Multicore Operation.";
      case -1074395399:
      ...
      case -1074395390:
        return "The contrast in the luminance plane of the image is too low to learn shape "
            + "features.";
      case -1074395389:
      ...
      case -1074395377:
        return "Invalid color template image.";
      case -1074395376:
        return "The color template image does not contain data required for shift-invariant color"
            + " matching.";
      case -1074395375:
        return "Invalid color template image.";
      case -1074395374:
      ...
      case -1074395373:
        return "Invalid color template image.";
      case -1074395372:
        return "The color template image does not contain data required for rotation-invariant "
            + "color matching.";
      case -1074395371:
        return "Invalid color template image.";
      case -1074395370:
      ...
      case -1074395367:
        return "Invalid color template image.";
      case -1074395366:
        return "The color template image does not contain data required for color matching in "
            + "shape feature mode.";
      case -1074395365:
        return "The color template image does not contain data required for color matching in "
            + "color feature mode.";
      ...
      case -1074395335:
        return "You are attempting to set the same algorithm to dispatch and to not dispatch. "
            + "Remove one of the conflicting settings.";
      case -1074395334:
      ...
      case -1074395311:
        return "The color spectrum array you provided does not contain enough elements or "
            + "contains an element set to not-a-number (NaN).";
      case -1074395310:
      ...
      case -1074395303:
        return "Invalid number of classes for auto threshold. Acceptable values range from 2 to "
            + "256.";
      case -1074395302:
      ...
      case -1074395287:
        return "The line you provided contains two identical points, or one of the coordinate "
            + "locations for the line is not a number (NaN).";
      case -1074395286:
      ...
      case -1074395261:
        return "An internal error occurred while attempting to access an invalid coordinate on an"
            + " image.";
      case -1074395260:
      ...
      case -1074395244:
        return "Invalid template descriptor.";
      case -1074395243:
        return "The template descriptor was created with a newer version of NI Vision. Upgrade to"
            + " the latest version of NI Vision to use this template.";
      case -1074395242:
        return "Invalid template descriptor.";
      case -1074395241:
        return "The template descriptor does not contain data required for rotation-invariant "
            + "matching.";
      case -1074395240:
        return "Invalid template descriptor.";
      case -1074395239:
        return "Invalid template descriptor.";
      case -1074395238:
        return "The template descriptor does not contain data required for shift-invariant "
            + "matching.";
      case -1074395237:
        return "Invalid template descriptor.";
      case -1074395235:
      ...
      case -1074395212:
        return "The size of the template string must match the size of the string you are trying "
            + "to correct.";
      case -1074395211:
        return "The supplied text template contains nonstandard characters that cannot be "
            + "generated by OCR.";
      case -1074395210:
        return "At least one character in the text template was of a lexical class that did not "
            + "match the supplied character reports.";
      case -1074395203:
        return "The OCR library cannot be initialized correctly.";
      case -1074395201:
        return "There was a failure when loading one of the internal OCR engine or LabView "
            + "libraries.";
      case -1074395200:
        return "One of the parameters supplied to the OCR function that generated this error is "
            + "invalid.";
      case -1074395179:
      ...
      case -1074395171:
        return "The system could not locate the initialization file required for OCR "
            + "initialization.";
      case -1074395170:
      ...
      case -1074395166:
        return "The system could not locate the OCR binary directory required for OCR "
            + "initialization.";
      case -1074395165:
        return "The system could not locate the OCR weights directory required for OCR "
            + "initialization.";
      case -1074395164:
      ...
      case -1074395160:
        return "NI Vision does not support the maximum point size you supplied.  Valid values "
            + "range from 4 to 72.";
      case -1074395159:
        return "NI Vision does not support the tolerance value you supplied.  Valid values are "
            + "non-negative.";
      case -1074395158:
      ...
      case -1074395149:
        return "Found a duplicate transform type in the properties array. Each properties array "
            + "may only contain one behavior for each transform type.";
      case -1074395148:
      ...
      case -1074395143:
        return "The data stream that was demodulated could not be read because the mode was not "
            + "detected.";
      case -1074395142:
