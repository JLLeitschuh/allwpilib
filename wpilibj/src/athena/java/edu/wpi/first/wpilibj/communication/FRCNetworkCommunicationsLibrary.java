...
public class FRCNetworkCommunicationsLibrary extends JNIWrapper {
   ...
   *                       the feature string.<br> Original signature : <code>uint32_t
   *                       report(tResourceType, uint8_t, uint8_t, const char*)</code>
   */
  public static native int FRCNetworkCommunicationUsageReportingReport(byte resource,
                                                                       byte instanceNumber, byte
  ...
  public static native int HALSendError(boolean isError, int errorCode, boolean isLVCode, String
      details, String location, String callStack, boolean printMsg);
}
