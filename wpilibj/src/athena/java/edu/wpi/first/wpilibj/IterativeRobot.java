 ...
 * entered: - DisabledInit() -- called only when first disabled - AutonomousInit() -- called each
 ...
 *
 * Periodic() functions -- each of these functions is called iteratively at the appropriate periodic
 * rate (aka the "slow loop"). The period of the iterative robot is synced to the driver station
 * control packets, giving a periodic frequency of about 50Hz (50 times per second). -
...
public class IterativeRobot extends RobotBase {
   ...
   * while the robot is in disabled mode.
   */
   ...
   *
   * Users should override this method for code which will be called periodically at a regular rate
   * while the robot is in teleop mode.
   */
