...
public class BinaryImage extends MonoImage {
  ...
  /**
   * removeSmallObjects filters particles based on their size. The algorithm erodes the image a
  ...
  /**
   * removeLargeObjects filters particles based on their size. The algorithm erodes the image a
