...
public class CanTalonJNI extends JNIWrapper {
  ...
  public static native long new_CanTalonSRX(int deviceNumber, int controlPeriodMs, int
      enablePeriodMs);
  ...
  public static native void GetMotionProfileStatus(long handle, Object canTalon, Object
      motionProfileStatus);
  ...
  public static native void PushMotionProfileTrajectory(long handle, int targPos, int targVel,
                                                        int profileSlotSelect, int timeDurMs, int
                                                            velOnly, int isLastPoint, int zeroPos);
