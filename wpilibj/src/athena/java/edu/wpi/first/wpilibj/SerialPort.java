...
/**
 * Driver for the RS-232 serial m_port on the RoboRIO.
 *
...
public class SerialPort {
   ...
   *
   * @param baudRate The baud rate to configure the serial m_port.
  ...
  /**
   * Force the output buffer to be written to the m_port.
   *
  ...
  /**
   * Reset the serial m_port driver to a known state.
   *
