...
public abstract class Command implements NamedSendable {
   ...
   * method for time-sensitive commands. </p> $
   *
   ...
   * cancel itself. $
   *
   * @return whether or not this {@link Command} will run when the robot is disabled, or if it will
   * cancel itself
   */
